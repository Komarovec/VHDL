...
HD_PWD='D:/Entertaiment/Programy/VHDL/VHDL/oled_nexys_video/NVideoTest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log oled_ctrl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source oled_ctrl.tcl -notrace
