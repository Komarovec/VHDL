...
synth_design -top oled_ctrl -part xc7a200tsbg484-3


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef oled_ctrl.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file oled_ctrl_utilization_synth.rpt -pb oled_ctrl_utilization_synth.pb"
