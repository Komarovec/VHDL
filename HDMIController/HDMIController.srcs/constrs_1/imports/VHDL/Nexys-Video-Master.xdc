...
set_property DIFF_TERM {1} [get_ports hdmi_tx_clk_p]
set_property DIFF_TERM {1} [get_ports hdmi_tx_p[0]]
set_property DIFF_TERM {1} [get_ports hdmi_tx_p[1]]
set_property DIFF_TERM {1} [get_ports hdmi_tx_p[2]]
